...
TMS_type = 2; %menu('Choose TMS pulse type:','Monophasic','Biphasic');
STEP_type = 2; %menu('Choose step time (us) :','5','25');
ipi = 100;
nump = 20;
%%
...
delay_start = 50; % delay at the beginning before TMS delivery
delay_end = 200; % delay after the TMS delivery
ipi = round(ipi/dt)*dt;
