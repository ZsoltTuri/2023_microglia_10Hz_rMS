function threshold = hpc_MSM_syn_weight_1_input(idx)
% Estimate the action potential threshold for single-pulse TMS at a given MSO percent.
...
sim = 1; % 1st column = one synaptic input
...
folder_name = [workspace filesep sim_folder filesep 'Models' filesep model_names{idx, 1} filesep 'Results' filesep 'E-field_Coupling'];
