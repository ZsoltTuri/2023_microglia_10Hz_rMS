...
########## Begin Slurm header ########## 
# Job name 
#SBATCH --job-name=efield_modeling
...
matlab –nodesktop -nodisplay -nojvm -singleCompThread -batch "hpc_prep_mesh"
cd 2021_microglia_rMS/sim_efm 
gmsh -3 -format stl -o 2_stl/brain_slice.stl 1_geo/brain_slice.geo 
gmsh -3 -format stl -o 2_stl/petri_dish.stl 1_geo/petri_dish.geo 
gmsh -3 -format msh2 -o 3_msh/invitro.msh 1_geo/invitro.geo 
cd 2021_microglia_rMS/src 
matlab –nodesktop -nodisplay -nojvm -singleCompThread -batch "hpc_run_simnibs"
