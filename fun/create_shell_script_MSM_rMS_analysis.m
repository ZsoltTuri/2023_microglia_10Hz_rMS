function create_shell_script_MSM_rMS_analysis(var)
arguments
    var.out_path
    var.out_name
    var.jobname
...
fprintf(fid, strcat('matlab –nodesktop -nodisplay -nojvm -batch', space, '"hpc_MSM_rMS_analysis(${SLURM_ARRAY_TASK_ID})"', '\n'));
fclose(fid);
end