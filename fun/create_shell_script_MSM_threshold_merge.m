function create_shell_script_MSM_threshold_merge(var)
arguments
    var.out_path
    var.out_name
    var.jobname
...
% fprintf(fid, strcat('matlab –nodesktop -nodisplay -nojvm -batch', space, '"hpc_MSM_syn_weight_merge"', '\n'));
fprintf(fid, strcat('matlab –nodesktop -nodisplay -batch', space, '"hpc_MSM_syn_weight_merge"', '\n'));
fclose(fid);
end