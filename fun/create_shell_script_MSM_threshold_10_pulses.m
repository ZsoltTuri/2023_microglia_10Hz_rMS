function create_shell_script_MSM_threshold_10_pulses(var)
arguments
    var.out_path
    var.out_name
    var.jobname
...
fprintf(fid, strcat('matlab –nodesktop -nodisplay -nojvm -batch', space, '"hpc_MSM_syn_weight_10_input(${SLURM_ARRAY_TASK_ID})"', '\n'));
